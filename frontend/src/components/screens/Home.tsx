...
export const Home: React.FC<HomeProps> = ({ 
  ...
  return (
    <div className="home-screen" style={{ width: '100%', height: '100%', position: 'relative' }}>
      {/* ★ ここから中身を80%に縮小して中央に寄せるラッパー */}
      <div style={{ width: '100%', height: '100%', transform: 'scale(0.8)', transformOrigin: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
